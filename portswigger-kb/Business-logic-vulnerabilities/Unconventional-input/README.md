...
5. Tune negative quantity: `total = 133700 + quantity × cheap_price ≤ 10000`.
...
4. Register: `A×238@dontwannacry.com.YOUR-EMAIL-ID.web-security-academy.net`
5. Confirmation email arrives at `YOUR-EMAIL-ID` (real); stored email = `A×238@dontwannacry.com`.
...
2. Add jacket normally → total = $1337 - $124×price_of_cheap.
